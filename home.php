<?php
session_start(); // <-- INI HARUS DITAMBAHKAN DI BARIS PERTAMA
...
if ($result_customer->num_rows > 0) {
    ...
    // Ambil kalimat pertama dari nama
    $name_parts = explode(' ', $customer_data['name']);
    $customer_name = 'Hi, ' . $name_parts[0];
} else {
        ...
        <div class="col">
          <div class="card h-100 shadow-sm">
            ...
            <div class="card-body">
              ...
              <button onclick="purchaseProduct('<?= htmlspecialchars($row['product_id']) ?>')" class="btn btn-dark w-100"> 
                    Beli Sekarang
              </button>
            </div>
          </div>
